...
public class Socket {
    ...
    public void on() throws SocketException {
        setPowerState(PowerState.ON);
    }

    public void off() throws SocketException {
    ...
    public synchronized void handleMessage(MessageOld message) {
        ...
        switch (message.getMessageType()) {
            case DISCOVERY_RESPONSE: {
                PowerState powerState = MessageOld.getPowerStateMessage(message);
            ...
            case SOCKET_DATA_RESPONSE: {
                String label = MessageOld.getLabelFromMessage(message);
