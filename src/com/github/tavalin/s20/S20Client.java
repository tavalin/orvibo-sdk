...
public class S20Client {
	...
	/**
	 * The listener interface for receiving socketDiscovery events.
	 * The class that is interested in processing a socketDiscovery
	 * event implements this interface, and the object created
	 * with that class is registered with a component using the
	 * component's <code>addSocketDiscoveryListener<code> method. When
	 * the socketDiscovery event occurs, that object's appropriate
	 * method is invoked.
	 *
